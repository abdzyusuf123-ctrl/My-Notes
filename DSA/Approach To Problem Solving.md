...
1. **Cut unnecessary information** — focus only on the relevant parts of the problem.  
2. **Rephrase or rewrite** the problem in your own words to ensure full understanding.  
3. **Confirm the inputs and outputs** — clearly define what’s given and what’s expected.  

💡 *Goal:* You should be able to explain the problem to someone else in one or two sentences.
...
3. **Describe the computation** needed to get from input → output.  
4. **List edge cases** to watch out for (empty input, single element, large values, etc.).  

💡 *This snapshot acts as your problem blueprint.*
...
1. Start with a **brute-force solution** — solve it the simple way first.  
2. Then, look for a **pattern or optimization** that speeds up the process.  

💡 *Most DSA problems are pattern-based — recognizing them is key to efficiency.*
...
💡 *This is your game plan — think through it before touching any code.*
...
> 💭 *Think first. Code second. Optimize last.*
